...
class CreatePermissionTables extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create($tableNames['permissions'], function (Blueprint $table) {
            ...
            $table->string('name', 125);        // <= clave para evitar índice > 1000 bytes
            $table->string('guard_name', 125);  // <= idem
            $table->timestamps();
        ...
        Schema::create($tableNames['roles'], function (Blueprint $table) use ($teams, $columnNames) {
            ...
            $table->string('name', 125);        // <= acotado
            $table->string('guard_name', 125);  // <= acotado
            $table->timestamps();
