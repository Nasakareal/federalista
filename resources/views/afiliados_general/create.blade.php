...
@section('title','Nuevo afiliado general')

@section('content_header')
  <h1 class="text-center w-100">Crear afiliado general</h1>
@endsection
...
<div class="container-xl">
  <div class="card card-outline card-primary">
    <div class="card-body">
      ...
      <form action="{{ route('afiliados-general.store') }}" method="POST" autocomplete="off" enctype="multipart/form-data">
        @csrf
        ...
        <div class="mt-4 d-flex gap-2">
          <a href="{{ route('afiliados-general.index') }}" class="btn btn-secondary">Cancelar</a>
