...
@section('title','Editar afiliado general')

@section('content_header')
  <h1 class="text-center w-100">Editar afiliado general</h1>
@endsection
...
<div class="container-xl">
  <div class="card card-outline card-primary">
    <div class="card-body">
      ...
      <form action="{{ route('afiliados-general.update', $afiliadoGeneral->id) }}" method="POST" autocomplete="off" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="row g-3">
          ...
          <div class="col-md-6">
            ...
            <input
              type="text"
              name="{{ $fullNameField }}"
              value="{{ old($fullNameField, $afiliadoGeneral->{$fullNameField} ?? '') }}"
          ...
          <div class="col-md-2">
            ...
            <input type="number" name="edad" value="{{ old('edad', $afiliadoGeneral->edad) }}" min="0" max="120"
          ...
          <div class="col-md-4">
            ...
            @php
              $sexoOld  = old('sexo', $afiliadoGeneral->sexo ?? '');
          ...
          <div class="col-md-4">
            ...
            <input type="text" name="telefono" value="{{ old('telefono', $afiliadoGeneral->telefono) }}"
          ...
          <div class="col-md-4">
            ...
            <input type="email" name="email" value="{{ old('email', $afiliadoGeneral->email) }}"
          ...
          <div class="col-md-4">
            ...
            @php $munOld = old('municipio', $afiliadoGeneral->municipio); @endphp
          ...
          <div class="col-md-2">
            ...
            <input type="text" name="cve_mun" id="txtCveMun"
                   value="{{ old('cve_mun', $afiliadoGeneral->cve_mun) }}" maxlength="3" readonly
          ...
          <div class="col-md-2">
            ...
            <input type="text" name="seccion" value="{{ old('seccion', $afiliadoGeneral->seccion) }}" list="dlSecciones"
          ...
          <div class="col-md-2">
            ...
            <input type="number" name="distrito_local" value="{{ old('distrito_local', $afiliadoGeneral->distrito_local) }}"
          ...
          <div class="col-md-2">
            ...
            <input type="number" name="distrito_federal" value="{{ old('distrito_federal', $afiliadoGeneral->distrito_federal) }}"
                   min="1" max="100" step="1" inputmode="numeric" pattern="[0-9]*"
          ...
          <div class="col-md-4">
            ...
            <input type="text" name="localidad" value="{{ old('localidad', $afiliadoGeneral->localidad) }}"
          ...
          <div class="col-md-4">
            ...
            <input type="text" name="colonia" value="{{ old('colonia', $afiliadoGeneral->colonia) }}"
          ...
          <div class="col-md-4">
            ...
            <input type="text"
                   name="clave_elector"
                   value="{{ old('clave_elector', $afiliadoGeneral->clave_elector) }}"
                   maxlength="18"
          ...
          <div class="col-md-6">
            ...
            @if(!empty($afiliadoGeneral->ine_frente))
              <small class="d-block mt-1">
                <a href="{{ asset('storage/'.$afiliadoGeneral->ine_frente) }}" target="_blank" rel="noopener">Ver actual</a>
              </small>
            @endif
          </div>
          ...
          <div class="col-md-6">
            ...
            @if(!empty($afiliadoGeneral->ine_reverso))
              <small class="d-block mt-1">
                <a href="{{ asset('storage/'.$afiliadoGeneral->ine_reverso) }}" target="_blank" rel="noopener">Ver actual</a>
              </small>
            @endif
          </div>
          ...
          <div class="col-md-12">
            ...
            <textarea name="perfil" rows="2"
                      ...
                      {{ $req('perfil') ? 'required' : '' }}>{{ old('perfil', $afiliadoGeneral->perfil) }}</textarea>
          ...
          <div class="col-md-12">
            ...
            <textarea name="observaciones" rows="2"
                      ...
                      {{ $req('observaciones') ? 'required' : '' }}>{{ old('observaciones', $afiliadoGeneral->observaciones) }}</textarea>
            @error('observaciones')<div class="invalid-feedback">{{ $message }}</div>@enderror
          </div>

          <div class="col-md-3">
            @php
              $estatusOld = old('estatus', $afiliadoGeneral->estatus ?? 'pendiente');
          ...
          <div class="col-md-4">
            ...
            <input type="datetime-local" name="fecha_convencimiento"
                   value="{{ old('fecha_convencimiento', optional($afiliadoGeneral->fecha_convencimiento)->format('Y-m-d\TH:i')) }}"
        ...
        <div class="mt-4 d-flex gap-2">
          <a href="{{ route('afiliados-general.show', $afiliadoGeneral->id) }}" class="btn btn-secondary">Cancelar</a>
